    ...
    <div class="row">
        <nav class="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('admin.mycourses') }}">🗂 My Courses</a>
                </li>
            </ul>
        </nav>
        <main class="main-content">
            <div class="navbar-admin">
                <span class="navbar-brand">My Courses</span>
                <div class="gap-3">
            ...
            <div class="welcome">
                <h2>My Courses</h2>
                <p class="lead mb-0">This is the My Courses page. You can customize this section as needed.</p>
            </div>
        </main>
    </div>
</div>
