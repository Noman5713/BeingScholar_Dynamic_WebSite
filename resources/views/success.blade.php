...
@section('content')
    <div class="success-header">
        <div class="container">
            ...
            <p>Discover how BeingScholar has transformed careers and lives. Read inspiring success stories from our students and share your own journey with our community.</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="success-grid">
            @if(isset($stories) && $stories->count() > 0)
                @foreach($stories as $story)
                    <div class="success-card" data-category="{{ $story->category }}">
                        ...
                        @else
                            <img src="{{ asset('images/success/default.jpg') }}" alt="{{ $story->title }}" class="success-image">
                        @endif
            ...
            <div class="success-card" data-category="programming">
                <img src="{{ asset('images/success/success1.jpg') }}" alt="Success Story" class="success-image">
                <div class="success-info">
                    <h3 class="success-title">From Beginner to Full-Stack Developer in 6 Months</h3>
                    <div class="success-meta">
                        <div class="success-author">
                            <img src="{{ asset('images/students/student1.jpg') }}" alt="Author" class="author-avatar">
                    ...
                    <p class="success-content">Before joining BeingScholar, I had zero coding experience. The comprehensive curriculum and supportive instructors helped me master full-stack development. Within 6 months, I landed a job at a tech startup with a salary that exceeded my expectations. The hands-on projects were particularly valuable as they closely mimicked real-world scenarios.</p>
                    <div class="success-footer">
            ...
            <div class="success-card" data-category="data-science">
                <img src="{{ asset('images/success/success2.jpg') }}" alt="Success Story" class="success-image">
                <div class="success-info">
                    <h3 class="success-title">Career Transition to Data Science</h3>
                    <div class="success-meta">
                        <div class="success-author">
                            <img src="{{ asset('images/students/student2.jpg') }}" alt="Author" class="author-avatar">
                    ...
                    <p class="success-content">I was working in marketing but wanted to pivot to data science. BeingScholar's structured program made this transition possible. The instructors were patient with beginners and the community support was incredible. Now I'm working as a junior data analyst at a leading company, applying what I learned in real-world data projects.</p>
                    <div class="success-footer">
            ...
            <div class="success-card" data-category="design">
                <img src="{{ asset('images/success/success3.jpg') }}" alt="Success Story" class="success-image">
                <div class="success-info">
                    <h3 class="success-title">Became a Freelance UI/UX Designer</h3>
                    <div class="success-meta">
                        <div class="success-author">
                            <img src="{{ asset('images/students/student3.jpg') }}" alt="Author" class="author-avatar">
                    ...
                    <p class="success-content">The UI/UX Design course at BeingScholar was transformative. I learned both theory and practical skills that allowed me to build a strong portfolio. Within weeks of completing the course, I secured my first freelance client. Now I have a consistent stream of projects and I'm making more than I did in my previous job.</p>
                    <div class="success-footer">
            ...
            <div class="success-card" data-category="business">
                <img src="{{ asset('images/success/success4.jpg') }}" alt="Success Story" class="success-image">
                <div class="success-info">
                    <h3 class="success-title">Launched My Own Digital Marketing Agency</h3>
                    <div class="success-meta">
                        <div class="success-author">
                            <img src="{{ asset('images/students/student4.jpg') }}" alt="Author" class="author-avatar">
                    ...
                    <p class="success-content">After completing the Digital Marketing course, I gained the confidence to start my own agency. The practical assignments helped me understand client needs and develop effective strategies. The business planning module was particularly helpful in setting up my company structure and acquiring my first clients.</p>
                    <div class="success-footer">
            ...
            <!-- Success Story 5 -->
            <div class="success-card" data-category="programming">
                <img src="{{ asset('images/success/success5.jpg') }}" alt="Success Story" class="success-image">
                <div class="success-info">
                    <h3 class="success-title">Doubled My Salary with AI Development Skills</h3>
                    <div class="success-meta">
                        <div class="success-author">
                            <img src="{{ asset('images/students/student5.jpg') }}" alt="Author" class="author-avatar">
                    ...
                    <p class="success-content">I was already a developer, but the AI specialization at BeingScholar opened new doors for me. The course was challenging but incredibly rewarding. I applied my new skills at work and was promoted to a senior role with double my previous salary. The AI projects in my portfolio impressed my managers and set me apart from colleagues.</p>
                    <div class="success-footer">
            ...
            <!-- Success Story 6 -->
            <div class="success-card" data-category="data-science">
                <img src="{{ asset('images/success/success6.jpg') }}" alt="Success Story" class="success-image">
                <div class="success-info">
                    <h3 class="success-title">Remote Data Engineer Position at International Company</h3>
                    <div class="success-meta">
                        <div class="success-author">
                            <img src="{{ asset('images/students/student6.jpg') }}" alt="Author" class="author-avatar">
                    ...
                    <p class="success-content">BeingScholar's Big Data course provided me with the technical skills and confidence to apply for international positions. I now work remotely for a European tech company as a data engineer, earning in foreign currency while living in Bangladesh. The career counseling and interview preparation were invaluable parts of the program.</p>
                    <div class="success-footer">
